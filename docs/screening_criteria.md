...
- [ ] **(데스크탑에서 진행 예정, 2026-09-18 착수)** 2014~2018 구간 out-of-sample 검증 — 2019~2025로 도출한 결론들(annual/avg_4q/per_weight 전부 열세, 5개 warning_tags 중 4개는 게이트 부적합)이 이 특정 시장 국면에 과적합된 건 아닌지 확인. **별도 DART_API_KEY 발급 권장**(같은 키를 노트북과 동시에 쓰면 일일 호출 한도를 공유하게 됨 — 2026-09-11 논의 참고). 절차:
